...
public class QueryConfigs extends AbstractRequest {
    ...
    /**
     * sends all config requests to completely populate Configuration class
     */
    ...
    /**
     * sends a request to TMDB API to get configuration on valid image formats and keywords
     * updates directly the Configuration class
     */
    ...
    /**
     * sends a request to TMDB API to get configuration on valid Countries
     * updates directly the Configuration class
     */
    ...
    /**
     * sends a request to TMDB API to get configuration valid jobs and departments
     * updates directly Configuration class
     */
    public void getJobs() {
    ...
    /**
     * sends a request to TMDB API to get configuration on valid languages
     * updates directly Configuration class
     */
    ...
    /**
     * sends a request to TMDB API to get configuration on valid translations
     * updates directly Configuration class
     */
    ...
    /**
     * sends a request to TMDB API to get configuration on valid timezones
     * updates directly Configuration class
     */
